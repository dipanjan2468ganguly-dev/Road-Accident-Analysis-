...
Tech Stack:
Data Processing: Python (pandas)  Data Visualization: matplotlib, seaborn, and squarify  Visualizations Used: Countplots, Box plots, KDE Plots, Heatmaps, and Line Charts  
Key Insights & Findings:
Road Types: Highways and rural roads generally demonstrate higher accident risks compared to urban roads.  Infrastructural Impact: Accident risk generally increases with higher speed limits and greater road curvature.  Environmental Factors: Nighttime (dim lighting) and adverse weather conditions (such as rain or fog) correspond to higher accident probabilities.  Correlations: Correlation coefficients highlight that curvature and lighting are the top numerical influencers of accident risk.  
